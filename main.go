...
import (
	...
	cacertscontrollers "kubeops.dev/csi-driver-ca-certificates-crds/controllers/cacerts"
...
func init() {
	...
	utilruntime.Must(cacertsv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4ab6f271.csi.appscode.com",
	})
	if err != nil {
